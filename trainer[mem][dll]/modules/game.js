...
class CGame {
    ...
    ShowPage() {
        ...
        if (tab == 0) {
            ...
            if (ImGui.IsItemClicked("ClockFrzAct")) {
                if (this.freezeClock){
                    Clock.Pause();
                } else {
                    Clock.Unpause();
            ...
            if (ImGui.IsItemClicked("hideHudFoc")) {
                if (this.hideHUD){
            ...
            if (ImGui.IsItemClicked("Stpproduc")) {
        ...
        if (tab == 1) {
            if (ImGui.CollapsingHeader("Field of view222")) {
                this.fov = ImGui.InputInt("FOV", this.fov, 10, 120);
                if (ImGui.IsItemClicked("fovFoc")) {
            ...
            if (ImGui.CollapsingHeader("Time222")) {
                this.hour = ImGui.InputInt("Hour", this.hour, 0, 23);
                if (ImGui.IsItemClicked("HourFo")) {
